...
final class BusinessUsersSignUpTextCell: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        */
        ...
        UICommonSetLabel(self.representativeLabel, text: "대표자(필수)", color: 3)
