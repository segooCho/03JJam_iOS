...
final class BusinessUsersSoup: UIViewController {
    //MARK: Properties
    ...
    init() {
        ...
        self.title = "국"
        //self.tabBarItem.image = UIImage(named: "tab-soup")
        //self.tabBarItem.selectedImage = UIImage(named: "tab-soup-selected")
        //데이터 임시 처리
        self.businessUsersMenu.append(BusinessUsersMenu(id: "1", code: "1", food: "된장국"))
        self.businessUsersMenu.append(BusinessUsersMenu(id: "1", code: "1", food: "김치찌개"))
        self.businessUsersMenu.append(BusinessUsersMenu(id: "1", code: "1", food: "미역국"))
    }
    ...
    override func viewDidLoad() {
        ...
        UICommonSetTextFieldEnable(self.textField, placeholderText:"국")
    ...
    func savaButtonDidTap() {
        ...
        //데이터 임시 처리
        self.businessUsersMenu.append(BusinessUsersMenu(id: "1", code: "1", food: "배춧국"))
