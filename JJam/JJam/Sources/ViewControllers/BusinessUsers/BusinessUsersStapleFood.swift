...
final class BusinessUsersStapleFood: UIViewController {
    //MARK: Properties
    ...
    init() {
        ...
        //데이터 임시 처리
        self.businessUsersMenu.append(BusinessUsersMenu(id: "1", code: "0", food: "현미밥"))
        self.businessUsersMenu.append(BusinessUsersMenu(id: "1", code: "0", food: "보리밥"))
        self.businessUsersMenu.append(BusinessUsersMenu(id: "1", code: "0", food: "짜장면"))
    }
    ...
    override func viewDidLoad() {
        ...
        UICommonSetTextFieldEnable(self.textField, placeholderText:"주식(밥,명)")
