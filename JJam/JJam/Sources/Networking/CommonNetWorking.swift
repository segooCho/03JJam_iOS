...
struct CommonNetWorking {
    ...
    static func mealBannerCheck(restaurant_Id: String, completion: @escaping (_ restaurantInfo: [RestaurantInfo]) -> Void) {
        let parameters: [String: Any] = [
            "osVer": osVer,
            "appVer": appVer,
            "restaurant_Id": restaurant_Id,
        ...
        var restaurantInfo: [RestaurantInfo] = []
        Alamofire.request(FixedBaseUrl.mealBannerCheck, method: .post, parameters: parameters, headers: headers)
            .validate(statusCode: 200..<400)
            .responseJSON {
                response in
                switch response.result {
