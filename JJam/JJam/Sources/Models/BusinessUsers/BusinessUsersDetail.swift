...
struct BusinessUsersDetail {
    ...
    init(id: String, imageString: String, dateString: String, division: String
        , stapleFood1: String, soup1: String, sideDish1: String, sideDish2: String
        , sideDish3: String, sideDish4: String, sideDish5: String, sideDish6: String
        , sideDish7: String, dessert1: String, dessert2: String, dessert3: String
        , remarks: String) {
        self.id = id
